...
def makeWebhookResult(req):
    ...
    speech = "MbColombiaDee encontrado " + cantidadResultados + " Resultados .   El atractivo que solicitaste es: " + tituloAtractivo + "  y la url de la imagen es: " + imagenAtractivo
