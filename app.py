...
#        imagenDefAtractivos = leerImagenAtractivos['media_details']['sizes']['medium']['source_url']#Interpreta el JSON de la imagen y extrae la URL de la imagen
        ...
        pruebatitulos = pruebatitulos + ("""                            {
                                ...
                                "subtitle": "Soy la descripción, colocar variable descripcionItem, incluyendo más car",
                                "buttons":  [
                                    {
                                        "type":"web_url",
...
def makeWebhookResult(req):
    ...
    speech = "MbColombiae encontrado " + cantidadResultados + " Resultados .   El atractivo que solicitaste es: " + tituloAtractivo + "  y la url de la imagen es: " + imagenAtractivo
