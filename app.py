...
def makeWebhookResult(req):
    ...
    speech = "Te encontrado " + cantidadResultados + " Resultados .   El atractivo que solicitaste es: " + tituloAtractivo + "  y la url de la imagen es: " + imagenAtractivo
    global fbMsg
    fbMsg = {
            "facebook" : {
#                "text":{
