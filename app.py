...
def listadoBusqueda(urlBaseJson, urlBaseImagen):
    return inicioFBCard, finFBCard, urlBaseImagen
...
def makeWebhookResult(req):
    ...
    speech = "Qe encontrado " + cantidadResultados + " Resultados .   El atractivo que solicitaste es: " + tituloAtractivo + "  y la url de la imagen es: " + imagenAtractivo
    fbMsg = {
            "facebook" : {
#                "text":{
