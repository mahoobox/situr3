...
def listadoBusqueda(urlBaseJson, urlBaseImagen):
    ...
    for x in range(0,len(urlBaseJson)):
        ...
        descripcionItem = re.sub("<.*?>", "", (urlBaseJson[x]['excerpt']['rendered'])[0:82])#Descripción del atractivo eliminando etiquetas
...
def makeWebhookResult(req):
    ...
    speech = "YQe encontrado " + cantidadResultados + " Resultados .   El atractivo que solicitaste es: " + tituloAtractivo + "  y la url de la imagen es: " + imagenAtractivo
